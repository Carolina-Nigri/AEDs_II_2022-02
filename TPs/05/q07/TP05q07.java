...
class TP05q07 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileWriter logFile = new FileWriter("matricula_hashIndireta.txt");
        BufferedReader input = new BufferedReader(new InputStreamReader(System.in));
        
        HashIndiretoLista hashGames = new HashIndiretoLista(21);
...
// classe HashIndiretoLista de Games
class HashIndiretoLista {
    private Lista tabela[]; // tabela de hash contem uma lista em cada posicao
    ...
    public HashIndiretoLista(int tamanho){
        ...
        tabela = new Lista[tamanho]; // cria um array de Lista
        for(int i = 0; i < tamanho; i++){
            tabela[i] = new Lista(); // cria uma Lista em cada posicao
        }
    }
    ...
    // remove de uma posicao da tabela hash
    public Game remover(Game elemento) throws Exception{
        ...
        if( !pesquisar(elemento.getName()) ){
            ...
            if(posLista != -1)
                removido = tabela[pos].remover(posLista);
        }
