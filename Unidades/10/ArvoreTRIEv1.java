/**
 * Classe ArvoreTRIEv1
 * => Implementacao de inserir sem permitir insercao de palavras que sejam prefixo
...
class ArvoreTRIEv1 {
     ...
     * possuir e setando fim quando terminar de inserir chars. 
     * @param str String a ser inserida
     * @param no NoTRIE atual 
     * @param i int Posicao da string
     */
    private void inserir(String str, NoTRIE no, int i) throws Exception {
        ...
        // nó filho ja possui letra, nao é fim de uma cadeia e char i nao é ultimo 
        } else if( !(no.filhos[str.charAt(i)].fimS) && (i < (str.length() - 1)) ){
            inserir(str, no.filhos[str.charAt(i)], i + 1);

        } else { // erro
            throw new Exception("Erro ao inserir! Palavra ou prefixo ja inseridos");
        } 
    }   
}
